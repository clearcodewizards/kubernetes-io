...
module Kubernetes
  ...
  class V2beta2HorizontalPodAutoscalerStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:currentMetrics) && (value = attributes[:currentMetrics]).is_a?(Array)
    ...
    def hash
      [conditions, current_metrics, current_replicas, desired_replicas, last_scale_time,
