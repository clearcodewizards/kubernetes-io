...
module Kubernetes
  ...
  class V1ContainerStateTerminated
    ...
    def initialize(attributes = {})
      ...
      self.exit_code = attributes[:exitCode] if attributes.key?(:exitCode)

      self.finished_at = attributes[:finishedAt] if attributes.key?(:finishedAt)
      ...
      self.started_at = attributes[:startedAt] if attributes.key?(:startedAt)
    end
