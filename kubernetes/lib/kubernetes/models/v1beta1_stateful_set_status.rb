...
module Kubernetes
  ...
  class V1beta1StatefulSetStatus
    ...
    def initialize(attributes = {})
      ...
      self.current_revision = attributes[:currentRevision] if attributes.key?(:currentRevision)
      ...
      self.update_revision = attributes[:updateRevision] if attributes.key?(:updateRevision)
    ...
    def hash
      [collision_count, conditions, current_replicas, current_revision, observed_generation,
