...
module Kubernetes
  ...
  class V1beta1CustomResourceConversion
    ...
    def initialize(attributes = {})
      ...
      return unless attributes.key?(:webhookClientConfig)

      self.webhook_client_config = attributes[:webhookClientConfig]
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        webhook_client_config == other.webhook_client_config
    end
