...
module Kubernetes
  ...
  class V2beta1ExternalMetricSource
    ...
    def initialize(attributes = {})
      ...
      self.metric_selector = attributes[:metricSelector] if attributes.key?(:metricSelector)

      if attributes.key?(:targetAverageValue)
        self.target_average_value = attributes[:targetAverageValue]
      end

      return unless attributes.key?(:targetValue)
