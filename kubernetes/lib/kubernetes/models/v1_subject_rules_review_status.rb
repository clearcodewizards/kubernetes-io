...
module Kubernetes
  ...
  class V1SubjectRulesReviewStatus
    ...
    def initialize(attributes = {})
      ...
      self.evaluation_error = attributes[:evaluationError] if attributes.key?(:evaluationError)

      self.incomplete = attributes[:incomplete] if attributes.key?(:incomplete)

      if attributes.key?(:nonResourceRules) && (value = attributes[:nonResourceRules]).is_a?(Array)
        self.non_resource_rules = value
      end

      return unless attributes.key?(:resourceRules)
      return unless (value = attributes[:resourceRules]).is_a?(Array)
