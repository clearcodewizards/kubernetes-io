...
module Kubernetes
  ...
  class V1beta1DaemonSetSpec
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:templateGeneration)
        self.template_generation = attributes[:templateGeneration]
      end

      return unless attributes.key?(:updateStrategy)

      self.update_strategy = attributes[:updateStrategy]
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        template_generation == other.template_generation &&
    ...
    def hash
      [min_ready_seconds, revision_history_limit, selector, template, template_generation,
       update_strategy].hash
    end
