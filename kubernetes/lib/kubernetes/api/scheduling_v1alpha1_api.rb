...
module Kubernetes
  class SchedulingV1alpha1Api
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1PriorityClass, Fixnum, Hash)>] V1alpha1PriorityClass data, response status code and response headers
    def create_priority_class_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling SchedulingV1alpha1Api.create_priority_class"
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
                                                        ...
                                                        return_type: 'V1alpha1PriorityClass')
      if @api_client.config.debugging
    ...
    def delete_priority_class_with_http_info(name, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling SchedulingV1alpha1Api.delete_priority_class"
      end

      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}'.sub(
        '{name}', name.to_s
      )
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1alpha1PriorityClassList, Fixnum, Hash)>] V1alpha1PriorityClassList data, response status code and response headers
    def list_priority_class_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
                                                        ...
                                                        body: post_body,
                                                        auth_names: auth_names,
                                                        return_type: 'V1alpha1PriorityClassList')
      if @api_client.config.debugging
    ...
    def patch_priority_class_with_http_info(name, body, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling SchedulingV1alpha1Api.patch_priority_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling SchedulingV1alpha1Api.patch_priority_class"
      end
    ...
    def read_priority_class_with_http_info(name, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling SchedulingV1alpha1Api.read_priority_class"
      end
    ...
    def replace_priority_class_with_http_info(name, body, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling SchedulingV1alpha1Api.replace_priority_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling SchedulingV1alpha1Api.replace_priority_class"
      end
