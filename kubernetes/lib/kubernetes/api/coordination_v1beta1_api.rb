...
module Kubernetes
  class CoordinationV1beta1Api
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1beta1Lease, Fixnum, Hash)>] V1beta1Lease data, response status code and response headers
    def create_namespaced_lease_with_http_info(namespace, body, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling CoordinationV1beta1Api.create_namespaced_lease"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling CoordinationV1beta1Api.create_namespaced_lease"
      end

      # resource path
      local_var_path = '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases'.sub(
    ...
    def delete_collection_namespaced_lease(namespace, opts = {})
      data, _status_code, _headers = delete_collection_namespaced_lease_with_http_info(namespace,
                                                                                       opts)
      data
    end
    ...
    def delete_collection_namespaced_lease_with_http_info(namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling CoordinationV1beta1Api.delete_collection_namespaced_lease"
      end
    ...
    def delete_namespaced_lease_with_http_info(name, namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling CoordinationV1beta1Api.delete_namespaced_lease"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling CoordinationV1beta1Api.delete_namespaced_lease"
      end

      # resource path
      local_var_path = '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}'.sub('{name}', name.to_s).sub(
        '{namespace}', namespace.to_s
      )
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1beta1LeaseList, Fixnum, Hash)>] V1beta1LeaseList data, response status code and response headers
    ...
    def list_namespaced_lease_with_http_info(namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling CoordinationV1beta1Api.list_namespaced_lease"
      end
    ...
    def patch_namespaced_lease(name, namespace, body, opts = {})
      data, _status_code, _headers = patch_namespaced_lease_with_http_info(name, namespace, body,
                                                                           opts)
      data
    end
    ...
    def patch_namespaced_lease_with_http_info(name, namespace, body, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling CoordinationV1beta1Api.patch_namespaced_lease"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling CoordinationV1beta1Api.patch_namespaced_lease"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling CoordinationV1beta1Api.patch_namespaced_lease"
      end
    ...
    def read_namespaced_lease_with_http_info(name, namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling CoordinationV1beta1Api.read_namespaced_lease"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling CoordinationV1beta1Api.read_namespaced_lease"
      end
    ...
    def replace_namespaced_lease(name, namespace, body, opts = {})
      data, _status_code, _headers = replace_namespaced_lease_with_http_info(name, namespace, body,
                                                                             opts)
      data
    end
    ...
    def replace_namespaced_lease_with_http_info(name, namespace, body, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling CoordinationV1beta1Api.replace_namespaced_lease"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling CoordinationV1beta1Api.replace_namespaced_lease"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling CoordinationV1beta1Api.replace_namespaced_lease"
      end
