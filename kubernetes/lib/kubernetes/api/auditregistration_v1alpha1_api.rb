...
module Kubernetes
  class AuditregistrationV1alpha1Api
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1alpha1AuditSink, Fixnum, Hash)>] V1alpha1AuditSink data, response status code and response headers
    def create_audit_sink_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuditregistrationV1alpha1Api.create_audit_sink"
      end
    ...
    def delete_audit_sink_with_http_info(name, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AuditregistrationV1alpha1Api.delete_audit_sink"
      end

      # resource path
      local_var_path = '/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}'.sub(
        '{name}', name.to_s
      )
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1alpha1AuditSinkList, Fixnum, Hash)>] V1alpha1AuditSinkList data, response status code and response headers
    def list_audit_sink_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
                                                        ...
                                                        body: post_body,
                                                        auth_names: auth_names,
                                                        return_type: 'V1alpha1AuditSinkList')
      if @api_client.config.debugging
    ...
    def patch_audit_sink_with_http_info(name, body, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AuditregistrationV1alpha1Api.patch_audit_sink"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuditregistrationV1alpha1Api.patch_audit_sink"
      end
    ...
    def read_audit_sink_with_http_info(name, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AuditregistrationV1alpha1Api.read_audit_sink"
      end
    ...
    def replace_audit_sink_with_http_info(name, body, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AuditregistrationV1alpha1Api.replace_audit_sink"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuditregistrationV1alpha1Api.replace_audit_sink"
      end
