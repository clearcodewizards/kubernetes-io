...
module Kubernetes
  class AutoscalingV1Api
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @return [Array<(V1HorizontalPodAutoscaler, Fixnum, Hash)>] V1HorizontalPodAutoscaler data, response status code and response headers
    def create_namespaced_horizontal_pod_autoscaler_with_http_info(namespace, body, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.create_namespaced_horizontal_pod_autoscaler"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AutoscalingV1Api.create_namespaced_horizontal_pod_autoscaler"
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
                                                        ...
                                                        return_type: 'V1HorizontalPodAutoscaler')
      if @api_client.config.debugging
    ...
    def delete_collection_namespaced_horizontal_pod_autoscaler_with_http_info(namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.delete_collection_namespaced_horizontal_pod_autoscaler"
      end
    ...
    def delete_namespaced_horizontal_pod_autoscaler_with_http_info(name, namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AutoscalingV1Api.delete_namespaced_horizontal_pod_autoscaler"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.delete_namespaced_horizontal_pod_autoscaler"
      end

      # resource path
      local_var_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}'.sub('{name}', name.to_s).sub(
        '{namespace}', namespace.to_s
      )
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1HorizontalPodAutoscalerList, Fixnum, Hash)>] V1HorizontalPodAutoscalerList data, response status code and response headers
    def list_horizontal_pod_autoscaler_for_all_namespaces_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
                                                        ...
                                                        body: post_body,
                                                        auth_names: auth_names,
                                                        return_type: 'V1HorizontalPodAutoscalerList')
      if @api_client.config.debugging
    ...
    def list_namespaced_horizontal_pod_autoscaler_with_http_info(namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.list_namespaced_horizontal_pod_autoscaler"
      end
    ...
    def patch_namespaced_horizontal_pod_autoscaler_with_http_info(name, namespace, body, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AutoscalingV1Api.patch_namespaced_horizontal_pod_autoscaler"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.patch_namespaced_horizontal_pod_autoscaler"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AutoscalingV1Api.patch_namespaced_horizontal_pod_autoscaler"
      end
    ...
    def patch_namespaced_horizontal_pod_autoscaler_status_with_http_info(name, namespace, body,
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AutoscalingV1Api.patch_namespaced_horizontal_pod_autoscaler_status"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.patch_namespaced_horizontal_pod_autoscaler_status"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AutoscalingV1Api.patch_namespaced_horizontal_pod_autoscaler_status"
      end

      # resource path
      local_var_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status'.sub('{name}', name.to_s).sub(
        '{namespace}', namespace.to_s
      )
    ...
    def read_namespaced_horizontal_pod_autoscaler_with_http_info(name, namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AutoscalingV1Api.read_namespaced_horizontal_pod_autoscaler"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.read_namespaced_horizontal_pod_autoscaler"
      end
    ...
    def read_namespaced_horizontal_pod_autoscaler_status_with_http_info(name, namespace, opts = {})
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AutoscalingV1Api.read_namespaced_horizontal_pod_autoscaler_status"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.read_namespaced_horizontal_pod_autoscaler_status"
      end
    ...
    def replace_namespaced_horizontal_pod_autoscaler_with_http_info(name, namespace, body,
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AutoscalingV1Api.replace_namespaced_horizontal_pod_autoscaler"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.replace_namespaced_horizontal_pod_autoscaler"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AutoscalingV1Api.replace_namespaced_horizontal_pod_autoscaler"
      end
    ...
    def replace_namespaced_horizontal_pod_autoscaler_status_with_http_info(name, namespace, body,
      ...
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling AutoscalingV1Api.replace_namespaced_horizontal_pod_autoscaler_status"
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AutoscalingV1Api.replace_namespaced_horizontal_pod_autoscaler_status"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AutoscalingV1Api.replace_namespaced_horizontal_pod_autoscaler_status"
      end
