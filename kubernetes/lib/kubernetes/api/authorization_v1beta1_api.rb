  ...
  class AuthorizationV1beta1Api
    ...
    def create_namespaced_local_subject_access_review_with_http_info(namespace, body, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace.nil?
        raise ArgumentError,
              "Missing the required parameter 'namespace' when calling AuthorizationV1beta1Api.create_namespaced_local_subject_access_review"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuthorizationV1beta1Api.create_namespaced_local_subject_access_review"
      end

      # resource path
      local_var_path = '/apis/authorization.k8s.io/v1beta1/namespaces/{namespace}/localsubjectaccessreviews'.sub(
    ...
    def create_self_subject_access_review_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuthorizationV1beta1Api.create_self_subject_access_review"
      end
    ...
    def create_self_subject_rules_review_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuthorizationV1beta1Api.create_self_subject_rules_review"
      end
    ...
    def create_subject_access_review_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuthorizationV1beta1Api.create_subject_access_review"
      end
