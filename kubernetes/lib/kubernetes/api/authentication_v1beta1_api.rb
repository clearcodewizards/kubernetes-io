...
module Kubernetes
  class AuthenticationV1beta1Api
    ...
    # @option opts [BOOLEAN] :include_uninitialized If IncludeUninitialized is specified, the object may be returned without completing initialization.
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @return [Array<(V1beta1TokenReview, Fixnum, Hash)>] V1beta1TokenReview data, response status code and response headers
    def create_token_review_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling AuthenticationV1beta1Api.create_token_review"
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
                                                        ...
                                                        return_type: 'V1beta1TokenReview')
      if @api_client.config.debugging
